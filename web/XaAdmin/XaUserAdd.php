    ...
    <div class="tabs">
    	<div class="tab">
    		<input  type="radio" id="tab-1" name="tab-group-1" checked onclick="
                    ...
                    'XaPage.php?obj=XaRbacRoleRXaUser&evt=GetXmlModel&tpl=Create&lay=Included&params={&quot;type&quot;:&quot;CreateWithExternalKey&quot;,&quot;XaUser_ID&quot;:&quot;'+UserId+'&quot;}&TplParams={&quot;obj&quot;:&quot;XaRbacRoleRXaUser&quot;,&quot;ResponseType&quot;:&quot;Text&quot;,&quot;WithAlert&quot;:&quot;yes&quot;}',
    	...
    	<div class="tab">
                <input  type="radio" id="tab-2" name="tab-group-1" onclick="
                    var UserId=document.getElementById('UserId').value;
                    if(UserId!=''){Xa.CallAction('',
                    'XaPage.php?obj=XaUserAddressGeo&evt=GetXmlModel&tpl=Create&lay=Included&params={&quot;type&quot;:&quot;CreateWithExternalKey&quot;,&quot;XaUser_ID&quot;:&quot;'+UserId+'&quot;}&TplParams={&quot;obj&quot;:&quot;XaUserAddressGeo&quot;,&quot;ResponseType&quot;:&quot;Text&quot;,&quot;WithAlert&quot;:&quot;yes&quot;}',
    	...
    	<div class="tab">
                <input  type="radio" id="tab-3" name="tab-group-1" onclick="
                    var UserId=document.getElementById('UserId').value;
                    if(UserId!=''){Xa.CallAction('',
                    'XaPage.php?obj=XaUserAddressPhone&evt=GetXmlModel&tpl=Create&lay=Included&params={&quot;type&quot;:&quot;CreateWithExternalKey&quot;,&quot;XaUser_ID&quot;:&quot;'+UserId+'&quot;}&TplParams={&quot;obj&quot;:&quot;XaUserAddressPhone&quot;,&quot;ResponseType&quot;:&quot;Text&quot;,&quot;WithAlert&quot;:&quot;yes&quot;}',
        ...
        <div class="tab">
                <input  type="radio" id="tab-4" name="tab-group-1" onclick="
                    var UserId=document.getElementById('UserId').value;
                    if(UserId!=''){Xa.CallAction('',
                    'XaPage.php?obj=XaUserAddressMail&evt=GetXmlModel&tpl=Create&lay=Included&params={&quot;type&quot;:&quot;CreateWithExternalKey&quot;,&quot;XaUser_ID&quot;:&quot;'+UserId+'&quot;}&TplParams={&quot;obj&quot;:&quot;XaUserAddressMail&quot;,&quot;ResponseType&quot;:&quot;Text&quot;,&quot;WithAlert&quot;:&quot;yes&quot;}',
